...
return array(
    ...
    array(
        ...
        'members' => array(
            ...
            array(
                'shortcode' => 'tabs',
                'insert' => '[tabs][tab title="First title"]First content here[/tab][tab title="Second title"]Second content[/tab][/tabs]',
            ...
            array(
                'shortcode' => 'pricing',
                'insert' => '[pricing heading="standard" price="10" per="month" featured="no"]<ul class="well-package-list"><li>1 project</li><li>5 GB Storage</li></ul>[button icon="" size="btn-large" type="primary" label="Sign Up" link="#"][/pricing]',
     ...
     */
     array(
        'title' => __('Custom', THEME_ADMIN_TD),
        'members' => array(
            array(
